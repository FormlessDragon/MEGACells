...
import com.gripe.megacells.block.MEGACraftingUnitType;
...
public final class MEGABlocks {
    ...
    public static final BlockDefinition<CraftingUnitBlock> MEGA_CRAFTING_UNIT = craftingUnit(
            "MEGA Crafting Unit", "mega_crafting_unit", MEGACraftingUnitType.UNIT);
    public static final BlockDefinition<CraftingUnitBlock> CRAFTING_ACCELERATOR = craftingUnit(
            "MEGA Crafting Co-Processing Unit", "mega_crafting_accelerator", MEGACraftingUnitType.ACCELERATOR);
    public static final BlockDefinition<CraftingUnitBlock> CRAFTING_STORAGE_1M = craftingUnit(
            "1M MEGA Crafting Storage", "1m_crafting_storage", MEGACraftingUnitType.STORAGE_1M);
    public static final BlockDefinition<CraftingUnitBlock> CRAFTING_STORAGE_4M = craftingUnit(
            "4M MEGA Crafting Storage", "4m_crafting_storage", MEGACraftingUnitType.STORAGE_4M);
    public static final BlockDefinition<CraftingUnitBlock> CRAFTING_STORAGE_16M = craftingUnit(
            "16M MEGA Crafting Storage", "16m_crafting_storage", MEGACraftingUnitType.STORAGE_16M);
    public static final BlockDefinition<CraftingUnitBlock> CRAFTING_STORAGE_64M = craftingUnit(
            "64M MEGA Crafting Storage", "64m_crafting_storage", MEGACraftingUnitType.STORAGE_64M);
    public static final BlockDefinition<CraftingUnitBlock> CRAFTING_STORAGE_256M = craftingUnit(
            "256M MEGA Crafting Storage", "256m_crafting_storage", MEGACraftingUnitType.STORAGE_256M);
    ...
    private static BlockDefinition<CraftingUnitBlock> craftingUnit(
            String englishName, String id, MEGACraftingUnitType type) {
        return block(englishName, id, () -> new CraftingUnitBlock(type), CraftingBlockItem::new);
    }
